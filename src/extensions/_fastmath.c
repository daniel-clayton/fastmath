...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // int()(int const *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 5), // int const *
/*  2 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // int()(int const *, int)
/*  4 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  5 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  7 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // int()(long long const *)
/*  8 */ _CFFI_OP(_CFFI_OP_POINTER, 10), // long long const *
/*  9 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 10 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 11), // long long
};

static int _cffi_d_naive_sum(int const * x0, int x1)
{
  return naive_sum(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_naive_sum(PyObject *self, PyObject *args)
{
  int const * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "naive_sum", 2, 2, &arg0, &arg1))
    return NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_sum256_32(PyObject *self, PyObject *arg0)
{
  int const * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#else
#  define _cffi_f_sum256_32 _cffi_d_sum256_32
#endif

static int _cffi_d_sum32(int const * x0)
{
  return sum32(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_sum32(PyObject *self, PyObject *arg0)
{
  int const * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_sum64(PyObject *self, PyObject *arg0)
{
  long long const * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
  ...
  if (datasize != 0) {
    x0 = ((size_t)datasize) <= 640 ? (long long const *)alloca((size_t)datasize) : NULL;
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__fastmath(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__fastmath(void) { return NULL; }
#  else
     init_fastmath(void) { }
#  endif
#  endif
...
{
  return _cffi_init("_fastmath", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_fastmath(void)
{
  _cffi_init("_fastmath", 0x2601, &_cffi_type_context);
}
#endif
